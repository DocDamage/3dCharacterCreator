...
#include "CharacterCreatorAnimationWorkspaceWidget.generated.h"
...
UCLASS()
class THREEDCHARACTER_API UCharacterCreatorAnimationWorkspaceWidget : public UUserWidget
{
    GENERATED_BODY()
...
private:
    ...
    FText GetAnimationSummary(const FCharacterAppearanceState& Appearance) const;
    ...
    UPROPERTY()
    TObjectPtr<UTextBlock> AnimationSummaryText;
    ...
    ECharacterCreatorScreen WorkspaceScreen = ECharacterCreatorScreen::AnimationOverview;
